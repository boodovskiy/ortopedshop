        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
            ...
            <div class="panel-body">
                ...
                <div class="row">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="panel-body tab-content" id="filter-category-tabs">
                                ...
                                <div
                                    ...
                                    <div class="row-fluid">
                                        <label for="filter-category_include_subcategories"><input name="filter-category_include_subcategories" type="checkbox" checked /> <?php echo $text_include_subcategories;?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="panel-body">
                                <input type="text" name="filter-manufacturer" value=""
                                       placeholder="<?php echo $text_manufacturers; ?>" id="filter-manufacturer"
                                       class="form-control" />
                    ...
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <h3><i class="fa fa-group"></i> <?php echo $text_customer_groups; ?></h3>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-default"><input class="form-control" type="radio"
                                                                                  name="unit"
                                                                                  value="<?php echo ModelModulePriceControl::PRICE_CONTROL_UNIT_NUMBER; ?>" /><?php echo $text_number; ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row-fluid text-right">
                                    ...
                                    <a href="<?php echo $backup_link; ?>">
                                        <button <?php echo(!$allow_backup ? "disabled" : ""); ?>
                                            ...
                                            type="button"><i class="fa fa-undo"></i> <?php echo $button_rollback; ?>
                                        </button>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="help text-center" style="text-align: center; display:none;"><?php echo $text_author;?><br /> Skype: <a
                    href="skype:efremovav91">efremovav91</a>, E-mail: <a
                    href="mailto:alex_uralsk14@mail.ru">alex_uralsk14@mail.ru</a><br /><?php echo $text_copyright;?>
            </div>
        </form>
    </div>
</div>
