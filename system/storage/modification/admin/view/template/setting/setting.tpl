            ...
            <div class="tab-pane" id="tab-sms">
              <fieldset>
				...
				<div class="tab-pane" id="tab-files">
				  ...
				  <fieldset>
					<legend><?php echo $support; ?></legend>
					<ul>
						<li><a href="mailto:prut.n.v@gmail.com?subject=Add files support&body=Сайт: <?php echo HTTP_SERVER; ?>">prut.n.v@gmail.com</a></li>
						<li><a href="https://www.facebook.com/nikolay.prut" target="_blank">https://www.facebook.com/nikolay.prut</a></li>
						<li><a href="https://vk.com/nikolay_prut" target="_blank">https://vk.com/nikolay_prut</a></li>
						<li><a href="http://for-opencart.com" target="_blank">http://for-opencart.com</a></li>
					</ul>
				  </fieldset>				  
				</div>	
