...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['review_count'] = $this->model_catalog_review->getTotalReviewsByProductId($this->request->get['product_id']);
          ...
          'points_value'                  => intval($option_value['points_prefix'].$option_value['points']),
			...
			$data['content_bottom'] = $this->load->controller('common/content_bottom');
				...
				$data['file_to_product'] = $this->load->controller('file/file'); //3274
