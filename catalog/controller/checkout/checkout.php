...
class ControllerCheckoutCheckout extends Controller { 
	...
	{ //echo "<pre>"; print_r($this->session->data); echo "</pre>";
		...
		$data['zone_id'] = $this->config->get('config_zone_id'); // Moscow from admin config tool
	...
	public function guest_validate() {
		...
		if ($data['opencart2'])
		{
			...
			if (!$json) {
				...
				if (isset($this->request->post['lastname']) && ((utf8_strlen(trim($this->request->post['lastname'])) < 0) || (utf8_strlen(trim($this->request->post['lastname'])) > 32))) {
	...
	//			unset($this->session->data['payment_methods']);
		...
		} else 
		{
			...
			if (!$json) {
				...
				if (isset($this->request->post['lastname']) && ((utf8_strlen($this->request->post['lastname']) < 0) || (utf8_strlen($this->request->post['lastname']) > 32))) {
					$json['error']['lastname'] = $this->language->get('error_lastname');
				}
