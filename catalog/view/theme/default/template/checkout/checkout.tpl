...
<div class="container">        
		...
		<div class="row">
			<div class="col-md-12">
			    ...
			    <p class="alert alert-info <!--well-->"><?php echo $text_returning_customer; ?> &nbsp;<a href="#" onclick="jQuery('.login-form').toggle();return false;"><?php echo $text_i_am_returning_customer; ?></a></p>
			    
			    <div class="login-form registerbox clearfix" style="display:none">
				<div class="row">
				<div class="col-md-12 message"></div>
				<form class="form-groupe" role="form">
			        <div class="col-md-6">
					<div class="row">
...
jQuery(document).ready(function()
{
	...
	/*$('#button-confirm').on('click', function(event) {
		event.preventDefault();console.log("Это он");
		var curPaymentMethod = $('[name=\'payment_method\']:checked').val();
		if(curPaymentMethod=="yamodule") {
			console.log("Это он");
