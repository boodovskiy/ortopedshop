<div class="box">
  ...
  <div class="box-content">
	...
	<div class="box-product <?php if ($productCount >= $sliderFor){?>product-carousel<?php }else{?>productbox-grid<?php }?>" id="<?php if ($productCount >= $sliderFor){?>product_category_main-<?php echo $category_id;?>-carousel<?php }else{?>product_category_main-<?php echo $category_id;?>-grid <?php }?>">
  ...
  <?php } ?>
	...
	<div id="home-panelgoods">
        <a href="<?php echo $category_href; ?>">показать все</a>
		<a href="<?php echo $category_href; ?>?sort=p.date_added&amp;order=DESC">новые поступления</a> 
		<a href="<?php echo $category_href; ?>?sort=rating&amp;order=DESC">товар со скидкой</a>
    </div>

	  
  </div>
</div>
<span class="product_category_main_default_width" style="display:none; visibility:hidden"></span>
