  ...
  <div class="row">
	...
	<h1><?php echo $heading_title; ?></h1>
      <div class="row">
		...
		<div class="product-left"><?php echo $column_left; ?></div>
		
		
		<?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6 image-box'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-4 image-box'; ?>
        <?php } ?>
   ...
   <div class="left product-image thumbnails">
    ...
    <?php } ?>
       ...
       <?php if ($column_left || $column_right) { ?>
        ...
        <?php } else { ?>
        <?php $class = 'col-sm-8 product-desc'; ?>
        <?php } ?>
        <div class="<?php echo $class; ?>">
          <!--<h1><?php /*echo $heading_title; */?></h1>-->
          ...
          <div id="product">
			  ...
			  <div class="product-option">
				...
				<?php foreach ($options as $option) { ?>
					...
					<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
					  <label class="control-label"><?php echo $option['name']; ?></label>
					  <button type="button" id="button-upload<?php echo $option['product_option_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default upload btn-block"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
			  ...
			  <div class="product-rightinfo">
					...
					<?php if ($price) { ?>
						  <ul class="list-unstyled">
							...
							<li class="price">
							  <span><?php echo $price; ?>
							  	<a class="callme" href="javascript:void(0)"><i class="fa fa-phone" aria-hidden="true"></i>Заказать обратный звонок</a>
							  </span>
							</li>
							<?php } else { ?>
							<li class="oldprice"><span style="text-decoration: line-through;"><?php echo $price; ?></span></li>
							<li class="specialprice">
							  <span><?php echo $special; ?></span>
							</li>
							<li class="call-me"><a class="callme" href="javascript:void(0)"><i class="fa fa-phone" aria-hidden="true"></i>Заказать обратный звонок</a></li>
							<?php } ?>
							<?php if ($tax) { ?>
				 ...
				 <div class="button-group">
						 <button type="button" id="button-cart" data-toggle="tooltip" title="<?php echo $button_cart; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button>
						<button type="button" data-toggle="tooltip" class="btn btn-default wishlist wishlist_button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"></button>
						<button type="button" data-toggle="tooltip" class="btn btn-default compare compare_button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"></button>
				  </div>
          ...
          <div class="rating">
            <div class="review-rating">
              ...
              <?php } ?>
              <?php } ?>
              <a class="reviews" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a> <a class="review" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $text_write; ?></a></div>
			...
			<script type="text/javascript">
				var addthis_config = {
					//services_compact: 'gmail,mymailru,email,linkedin'
				};
			</script>
		...
		<?php if ($column_left && $column_right) { ?>
        <?php $class = 'col-sm-6 product-description'; ?>
        <?php } elseif ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-12 product-description'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-12 product-description' ; ?>
        <?php } ?>
        <div class="<?php echo $class; ?>">
            ...
            <?php } ?>
            <?php if ($file_to_product) { ?>
            <li><a href="#tab-file" data-toggle="tab"><span class="hidden-xs"><?php echo $tab_file; ?></span></a></li>
            <?php } ?>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-review">
              <form class="form-horizontal" id="form-review">
                <div class="table-responsive"><div id="review"></div></div>
...
$priceMeta = '';
  if ($price){
     if (!$special){
		$priceMeta = $price; 
		$autocalc = "<span class='autocalc-product-price'>";
     }
     else{
		$priceMeta = $special;
		$autocalc = "<span class='autocalc-product-special'>";
     } 
  if(strpos($priceMeta, $autocalc) !== false){
    $priceMeta = str_replace($autocalc, '', $priceMeta);
    $priceMeta = str_replace(' р.</span>', '', $priceMeta);
  }else{
    $priceMeta = str_replace(' р.', '', $priceMeta);
  }
  $priceMeta = str_replace(' ', '', $priceMeta);
  }
